...
public class OrderRepository {
	...
	public Order findByIdAndStatusIs0(Integer userId) {
		String sql = "SELECT id,user_id,status,total_price,order_date,destination_name,destinationzip_code,destination_tell,destination_email,destination_address,delivery_time,payment_method FROM orders WHERE user_id = :id AND status = 0";
